...
const translations = {
  zh: {
    ...
    'home.milestones.title': '里程碑',
    'home.milestones.description': 'IEA在发展历程中取得的关键成就与高光时刻。',
    'home.milestones.button': '查看全部里程碑',
    ...
    'footer.email': 'Ling.sun@ieally.com',
    'footer.phone.au': '+61 0404806377 (澳洲)',
    'footer.phone.cn': '+86 15195839106 (中国)',
    'footer.wechat': '微信ID: lingsun2007',
    'footer.global': '全球布局',
  ...
  en: {
    ...
    'home.milestones.description': 'Key achievements and highlights in IEA’s development.',
    'home.milestones.button': 'View All Milestones',
    ...
    'footer.headquarters': 'GF/400 King William St, Adelaide, South Australia, 5000',
    'footer.email': 'Ling.sun@ieally.com',
    'footer.phone.au': '+61 0404806377 (Australia)',
    'footer.phone.cn': '+86 15195839106 (China)',
    'footer.wechat': 'WeChat ID: lingsun2007',
